    ...
    public class PieceJController : IPieceController
    {
        ...
        public IEnumerable<TetrisDrop> GetPossibleDrops(int stack)
        {
            ...
            for (int i = 0; i <= 6; i++)
            {
                ...
                yield return new TetrisDrop(Drop0(stack, i), Orientation.DEGREES_0, i, Piece.J);
            }
            ...
            for (int i = 0; i <= 7; i++)
            {
                ...
                yield return new TetrisDrop(Drop90(stack, i), Orientation.DEGREES_90, i, Piece.J);
            }
            ...
            for (int i = 0; i <= 6; i++)
            {
                ...
                yield return new TetrisDrop(Drop180(stack, i), Orientation.DEGREES_180, i, Piece.J);
            }
            ...
            for (int i = 0; i <= 7; i++)
            {
                ...
                yield return new TetrisDrop(Drop270(stack, i), Orientation.DEGREES_270, i, Piece.J);
            }
        }
