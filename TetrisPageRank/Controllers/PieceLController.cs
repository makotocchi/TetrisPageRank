    ...
    public class PieceLController : IPieceController
    {
        ...
        public List<TetrisDrop> GetPossibleDrops(int stack)
        {
            ...
            for (int i = 0; i <= 6; i++)
            {
                ...
                possibleDrops.Add(new TetrisDrop(Drop0(stack, i), Orientation.DEGREES_0, i, Piece.L));
            }
            ...
            for (int i = 0; i <= 7; i++)
            {
                ...
                possibleDrops.Add(new TetrisDrop(Drop90(stack, i), Orientation.DEGREES_90, i, Piece.L));
            }
            ...
            for (int i = 0; i <= 6; i++)
            {
                ...
                possibleDrops.Add(new TetrisDrop(Drop180(stack, i), Orientation.DEGREES_180, i, Piece.L));
            }
            ...
            for (int i = 0; i <= 7; i++)
            {
                ...
                possibleDrops.Add(new TetrisDrop(Drop270(stack, i), Orientation.DEGREES_270, i, Piece.L));
            }
