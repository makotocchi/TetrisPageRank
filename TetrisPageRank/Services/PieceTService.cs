    ...
    public class PieceTService : PieceService
    {
        ...
        public override List<TetrisDrop> GetPossibleDrops(int stack)
        {
            ...
            for (int i = 0; i <= 6; i++)
            {
                if (IsDrop0Possible(digits, i))
                {
                    possibleDrops.Add(new TetrisDrop(Drop0(stack, i), 0, i, Piece.T));
                }
            }
            ...
            for (int i = 0; i <= 7; i++)
            {
                if (IsDrop90Possible(digits, i))
                {
                    possibleDrops.Add(new TetrisDrop(Drop90(stack, i), 90, i, Piece.T));
                }
            }
            ...
            for (int i = 0; i <= 6; i++)
            {
                if (IsDrop180Possible(digits, i))
                {
                    possibleDrops.Add(new TetrisDrop(Drop180(stack, i), 180, i, Piece.T));
                }
            }
            ...
            for (int i = 0; i <= 7; i++)
            {
                if (IsDrop270Possible(digits, i))
                {
                    possibleDrops.Add(new TetrisDrop(Drop270(stack, i), 270, i, Piece.T));
                }
            }
